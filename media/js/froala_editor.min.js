...
!(function (e, t) {
	...
	(V.RegisterPlugins = function (e) {
		...
		Object.assign(V, { DEFAULTS: { initOnClick: !1, pluginsEnabled: null }, MODULES: {}, PLUGINS: {}, VERSION: "4.0.17", INSTANCES: [], OPTS_MAPPING: {}, SHARED: {}, ID: 0 }),
			...
			function L(e) {
				...
				!(function c(a) {
					...
					if (
						...
						a.nodeType === Node.ELEMENT_NODE && (a.getAttribute("data-fr-src") && 0 !== a.getAttribute("data-fr-src").indexOf("blob:") && a.setAttribute("data-fr-src", f.helpers.sanitizeURL(b(a.getAttribute("data-fr-src")))), a.getAttribute("href") && a.setAttribute("href", f.helpers.sanitizeURL(b(a.getAttribute("href")))), a.getAttribute("src") && a.setAttribute("src", f.helpers.sanitizeURL(b(a.getAttribute("src")))), a.getAttribute("srcdoc") && a.setAttribute("srcdoc", f.clean.html(a.getAttribute("srcdoc"))), 0 <= ["TABLE", "TBODY", "TFOOT", "TR"].indexOf(a.tagName) && (a.innerHTML = a.innerHTML.trim())),
			...
			return {
				...
				lists: function y() {
					!(function s() {
						...
						(function a() {
							for (var e = f.el.querySelectorAll("ul, ol"), t = 0; t < e.length; t++) for (var n = f.node.contents(e[t]), r = null, o = n.length - 1; 0 <= o; o--) (!n[o].tagName && f.opts.htmlUntouched) || "LI" === n[o].tagName || "UL" == n[o].tagName || "OL" == n[o].tagName ? (r = null) : "BR" == n[o].tagName ? g(n[o]).remove() : (r || (r = g(f.doc.createElement("LI"))).insertBefore(n[o]), r.prepend(n[o]));
						})(),
						(function l() {
							var e, t, n;
							do {
	...
	(V.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}")),
		...
		(V.MODULES.helpers = function (i) {
			...
			return {
				...
				sanitizeURL: function m(e) {
					return (
						i.opts.DOMPurify && (e = i.opts.DOMPurify.sanitize(e, { ADD_TAGS: i.opts.htmlAllowedTags, ALLOW_UNKNOWN_PROTOCOLS: !0, ALLOWED_URI_REGEXP: /^(?:(?:(?:f|ht)tps?|mailto|tel|callto|cid|xmpp|xxx):|[^a-z]|[a-z+.]+(?:[^a-z+.\-:]|$))/i })),
						/^(https?:|ftps?:|)\/\//i.test(e)
							? e
				...
				isInViewPort: function T(e) {
					...
					return (0 <= (t = { top: Math.round(t.top), bottom: Math.round(t.bottom) }).top && t.bottom <= (window.innerHeight || document.documentElement.clientHeight)) || (t.top <= 0 && t.bottom >= (window.innerHeight || document.documentElement.clientHeight));
				},
			};
		}),
			...
			function n(e, t) {
				if (!((a.markdown && a.markdown.isEnabled() && ("bold" === e || "italic" === e || "underline" === e)) || (a.opts.trackChangesEnabled && "markdown" === e)) && !1 !== a.events.trigger("commands.before", s.merge([e], t || []))) {
					var n = (V.COMMANDS[e] && V.COMMANDS[e].callback) || i[e],
						r = !0,
						o = !1;
					V.COMMANDS[e] && ("undefined" != typeof V.COMMANDS[e].focus && (r = V.COMMANDS[e].focus), "undefined" != typeof V.COMMANDS[e].accessibilityFocus && (o = V.COMMANDS[e].accessibilityFocus)), ((!a.core.hasFocus() && r) || (!a.core.hasFocus() && o && a.accessibility.hasFocus())) && (a.el.focus({ preventScroll: !0 }), a.events.trigger("focus")), V.COMMANDS[e] && !1 !== V.COMMANDS[e].undo && (a.$el.find(".fr-marker").length && (a.events.disableBlur(), a.selection.restore()), a.undo.saveStep()), n && n.apply(a, s.merge([e], t || [])), a.events.trigger("commands.after", s.merge([e], t || [])), V.COMMANDS[e] && !1 !== V.COMMANDS[e].undo && a.undo.saveStep();
				}
			}
			function e(e, t) {
				a.format.toggle(t);
			...
			function E(e) {
				...
				if ((!g.node.isBlock(n) || (n.lastChild && o && 0 <= r.indexOf(o))) && g.node.isEditable(n)) {
					...
					if (n.nodeType === Node.TEXT_NODE) {
						...
						var s = n.textContent;
						((g.opts.enter === V.ENTER_BR && 0 < s.length && " " === s.charAt(s.length - 1)) || (0 === s.length && e.previousSibling && 3 === e.previousSibling.nodeType && "TD" !== e.parentNode.tagName && "LI" !== e.parentNode.tagName && i !== String.fromCharCode(8203))) && (e.insertAdjacentHTML("beforebegin", V.INVISIBLE_SPACE), (n = n.nextSibling)),
							g.opts.trackChangesEnabled && 0 === n.textContent.length && C(n.parentElement).data("tracking") && 0 === C(n.parentElement).find("[data-tracking-deleted=true]").length && (C(e).insertBefore(n.parentElement), C(n.parentElement).remove(), (n = C(e)[0].previousSibling)),
					...
					if (g.node.isBlock(n) && (g.node.isEditable(n) || g.node.isDeletable(n)) && i && V.NO_DELETE_TAGS.indexOf(i.tagName) < 0)
						if (g.node.isDeletable(i)) C(i).remove(), C(e).replaceWith(V.MARKERS);
							...
							if (g.node.isList(i))
								...
								if (((o = g.node.contents(i)).length && "BR" === o[0].tagName && C(o[0]).remove(), "BLOCKQUOTE" !== i.tagName && "BLOCKQUOTE" === n.tagName)) for (o = g.node.contents(n); o.length && g.node.isBlock(o[o.length - 1]); ) (n = o[o.length - 1]), (o = g.node.contents(n));
													...
													if (g.node.isDeletable(a)) C(a).remove(), C(e).replaceWith(V.MARKERS);
														...
														if (g.node.isBlock(a))
															if (g.node.isEmpty(a) && !g.node.isList(a)) C(a).remove(), C(e).after(g.opts.keepFormatOnDelete ? V.INVISIBLE_SPACE : "");
																...
																if ((g.node.isList(a) && (a = C(a).find("li").last().get(0)), (i = g.node.contents(a)).length && "BR" === i[i.length - 1].tagName && C(i[i.length - 1]).remove(), "BLOCKQUOTE" === a.tagName && "BLOCKQUOTE" !== n.tagName)) for (i = g.node.contents(a); i.length && g.node.isBlock(i[i.length - 1]); ) (a = i[i.length - 1]), (i = g.node.contents(a));
			...
			function t(e, t) {
				...
				if (x.selection.isCollapsed()) {
					...
					if (x.node.openTagString(d.get(0)) === '<span style="'.concat(e, ": ").concat(d.css(e), ';">')) {
						...
						x.html.cleanEmptyTags();
					} else x.node.isEmpty(d.get(0)) && d.is("span") ? (r.replaceWith(V.MARKERS), d.css(e, t)) : (r.get(0).nextSibling && x.node.isBlock(r.get(0).nextSibling) && !r.get(0).previousSibling && "LI" === r.get(0).parentNode.tagName && r.get(0).nextSibling.prepend(r.get(0)), (c = O('<span style="'.concat(e, ": ").concat(t, ';">').concat(V.INVISIBLE_SPACE).concat(V.MARKERS, "</span>"))), r.replaceWith(c));
					c && L(c, e, t);
				} else {
					if ((x.selection.save(), null === t || ("color" === e && 0 < x.$el.find(".fr-marker").parents("u, a").length))) {
						var p = x.$el.find(".fr-marker");
						for (n = 0; n < p.length; n++)
							if (!0 === (r = O(p[n])).data("type") || "true" === r.data("type")) for (; x.node.isFirstSibling(r.get(0)) && !r.parent().is(x.$el) && !x.node.isElement(r.parent().get(0)) && !x.node.isBlock(r.parent().get(0)); ) r.parent().before(r);
					...
					if (0 < a.length) {
						...
						try {
							...
							if (o.nextSibling === a || a.nextSibling === o) {
								...
								if (u && u.nodeType === Node.TEXT_NODE) for (; u && u.previousSibling && u.previousSibling.nodeType === Node.TEXT_NODE; ) (u.previousSibling.textContent += u.textContent), (u = u.previousSibling), y(u.nextSibling).remove();
		...
		Object.assign(V.DEFAULTS, { htmlAllowedEmptyTags: ["textarea", "a", "iframe", "object", "video", "style", "script", ".fa", ".fr-emoticon", ".fr-inner", "path", "line", "hr"], htmlDoNotWrapTags: ["script", "style"], htmlSimpleAmpersand: !1, htmlIgnoreCSSProperties: [], htmlExecuteScripts: !0 }),
				...
				get: function _(e, t) {
									...
									if (c[f].selectorText && 0 < c[f].style.cssText.length) {
										...
										for (o = 0; o < u.length; o++) {
											...
											for (var g = 1e3 * d + $(c[f].selectorText), C = c[f].style.cssText.split(";"), m = 0; m < C.length; m++) {
												...
												if (v && !v.match(l) && (a[u[o]][v] || ((a[u[o]][v] = 0) <= (u[o].getAttribute("fr-original-style") || "").indexOf("".concat(v, ":")) && (a[u[o]][v] = 1e4)), g >= a[u[o]][v] && ((a[u[o]][v] = g), C[m].trim().length))) {
					...
					if (w.node.isEmpty(w.el)) w.opts.fullPage && ((n = k(w.iframe_document)), (n += "<html".concat(w.node.attributes(w.$html.get(0)), ">").concat(w.$html.find("head").get(0).outerHTML, "<body></body></html>")));
						...
						var T = w.opts.heightMin,
							M = w.opts.height,
							A = w.opts.heightMax;
						(w.opts.heightMin = null), (w.opts.height = null), (w.opts.heightMax = null), w.size.refresh(), (n += "<html".concat(w.node.attributes(w.$html.get(0)), ">").concat(w.$html.html(), "</html>")), (w.opts.heightMin = T), (w.opts.height = M), (w.opts.heightMax = A), w.size.refresh(), w.$el.addClass("fr-view");
					} else n = w.$el.html();
					...
					w.opts.fullPage &&
						(n = (n = (n = (n = (n = (n = (n = (n = n.replace(/<style data-fr-style="true">(?:[\w\W]*?)<\/style>/g, "")).replace(/<link([^>]*)data-fr-style="true"([^>]*)>/g, "")).replace(/<style(?:[\w\W]*?)class="firebugResetStyles"(?:[\w\W]*?)>(?:[\w\W]*?)<\/style>/g, "")).replace(/<body((?:[\w\W]*?)) spellcheck="true"((?:[\w\W]*?))>((?:[\w\W]*?))<\/body>/g, "<body$1$2>$3</body>")).replace(/<body((?:[\w\W]*?)) contenteditable="(true|false)"((?:[\w\W]*?))>((?:[\w\W]*?))<\/body>/g, "<body$1$3>$4</body>")).replace(/<body((?:[\w\W]*?)) dir="([\w]*)"((?:[\w\W]*?))>((?:[\w\W]*?))<\/body>/g, "<body$1$3>$4</body>")).replace(/<body((?:[\w\W]*?))class="([\w\W]*?)(fr-rtl|fr-ltr)([\w\W]*?)"((?:[\w\W]*?))>((?:[\w\W]*?))<\/body>/g, '<body$1class="$2$4"$5>$6</body>')).replace(
		...
		(V.MODULES.paste = function (A) {
			...
			function f() {
				A.opts.iframe && A.$el.attr("contenteditable", "true"), A.browser.edge && A.opts.iframe && A.$box.after(l), w || (A.keys.forceUndo(), (w = A.snapshot.get())), a || ((a = l.get(0).innerHTML), (x = l.text()), A.$el[0].setAttribute("plainpaste", !0), A.selection.restore(), A.events.enableBlur());
			...
			function i(e, t, n) {
				...
				if ((A.$el[0].removeAttribute("plainpaste", !0), "string" == typeof d && (e = d), "" !== e)) {
					...
					if (A.opts.enter === V.ENTER_BR) for (r = (o = f.querySelectorAll("p, div")).length - 1; 0 <= r; r--) 0 === (i = o[r]).attributes.length && (i.outerHTML = i.innerHTML + (i.nextSibling && !A.node.isEmpty(i) ? "<br>" : ""));
		...
		(V.MODULES.shortcuts = function (s) {
			...
			return {
				...
				get: function o(e) {
					...
					if (!r) for (var t in ((r = {}), V.SHORTCUTS_MAP)) Object.prototype.hasOwnProperty.call(V.SHORTCUTS_MAP, t) && 0 <= s.opts.shortcutsEnabled.indexOf(V.SHORTCUTS_MAP[t].cmd) && (r["".concat(V.SHORTCUTS_MAP[t].cmd, ".").concat(V.SHORTCUTS_MAP[t].val || "")] = { shift: V.SHORTCUTS_MAP[t].shift, option: V.SHORTCUTS_MAP[t].option, letter: V.SHORTCUTS_MAP[t].letter });
					var n = r[e];
				...
				(h.shared.exit_flag = !1),
				{
					...
					show: function T(e, t, n, r, o) {
						...
						if (
							...
							h.opts.toolbarInline && s && h.$tb && s.get(0) === h.$tb.get(0) && (C(e, h.$sc), (n = h.$tb.offset().top - h.helpers.getPX(h.$tb.css("margin-top"))), (t = h.$tb.offset().left + h.$tb.outerWidth() / 2), h.node.hasClass(h.$tb.get(0), "fr-above") && n && (n += h.$tb.outerHeight()), (r = 0)),
									...
									if (V.KEYCODE.TAB === n) {
										...
										if (V.KEYCODE.ENTER !== n || !e.target || "TEXTAREA" === e.target.tagName)
											return V.KEYCODE.ESC === n
												? (e.preventDefault(), e.stopPropagation(), t.accessibility.restoreSelection(), t.popups.isVisible(c) && d.findVisible(".fr-back").length ? (t.opts.toolbarInline && (t.events.disableBlur(), t.events.focus()), t.button.exec(d.findVisible(".fr-back").first()), E(d)) : t.popups.isVisible(c) && d.findVisible(".fr-dismiss").length ? t.button.exec(d.findVisible(".fr-dismiss").first()) : (t.popups.hide(c), t.opts.toolbarInline && t.toolbar.showInline(null, !0), E(d)), !1)
		...
		(V.MODULES.position = function (L) {
			...
			function o() {
				...
				if ((0 === t.top && 0 === t.left && 0 === t.width) || 0 === t.height) {
					...
					var i = o.offset(),
						a = o.outerHeight();
					o.css("display", "none"), o.css("line-height", 0), ((t = {}).left = i && i.left), (t.width = 0), (t.height = a), (t.top = i && i.top - ((L.helpers.isMobile() && !L.helpers.isIOS()) || L.opts.iframe ? 0 : L.helpers.scrollTop())), o && 0 < o.length && (t.top -= E(o.get(0).parentNode).height()), (t.right = 1), (t.bottom = 1), (t.ok = !0), n && (r ? L.$el.find(".fr-marker").remove() : L.selection.restore());
				}
				return t;
			}
			function i(e, t, n, r) {
			...
			function t(e) {
				if (e.offsetWidth) {
					...
					if ((t.data("sticky-offset") ? L.$box.find(".fr-sticky-dummy").css("height", "".concat(n, "px")) : (t.data("sticky-offset", !0), t.after('<div class="fr-sticky-dummy" style="height: '.concat(n, 'px;"></div>'))), !r)) {
						...
						p || t.css("position", "fixed"), (r = { top: L.node.hasClass(t.get(0), "fr-top"), bottom: L.node.hasClass(t.get(0), "fr-bottom") }), p || t.css("position", ""), t.data("sticky-position", r), t.data("top", L.node.hasClass(t.get(0), "fr-top") ? t.css("top") : "auto"), t.data("bottom", L.node.hasClass(t.get(0), "fr-bottom") ? t.css("bottom") : "auto");
					}
		...
		Object.assign(V.DEFAULTS, { attribution: !0, toolbarBottom: !1, toolbarButtons: null, toolbarButtonsXS: null, toolbarButtonsSM: null, toolbarButtonsMD: null, toolbarContainer: null, toolbarInline: !1, toolbarSticky: !0, toolbarStickyOffset: 0, toolbarVisibleWithoutSelection: !1 }),
		(V.TOOLBAR_BUTTONS = {
			...
			moreRich: { buttons: ["trackChanges", "markdown", "insertLink", "insertFiles", "insertImage", "insertVideo", "insertTable", "emoticons", "fontAwesome", "specialCharacters", "embedly", "insertFile", "insertHR"], buttonsVisible: 4 },
		...
		(V.MODULES.toolbar = function (E) {
						...
						if (c.buttons && ("trackChanges" !== l || -1 !== E.opts.pluginsEnabled.indexOf("track_changes"))) {
							...
							for (var u = 0; u < c.buttons.length; u++) {
								...
								var g = E.$tb.find('> .fr-command[data-cmd="' + c.buttons[u] + '"], > div.fr-btn-wrap > .fr-command[data-cmd="' + c.buttons[u] + '"]'),
									C = null;
								E.node.hasClass(g.next().get(0), "fr-dropdown-menu") && (C = g.next()), E.node.hasClass(g.next().get(0), "fr-options") && (g.removeClass("fr-hidden"), g.next().removeClass("fr-hidden"), (g = g.parent())), g.removeClass("fr-hidden"), i.showMoreButtons && p <= f ? (d.append(g), C && d.append(C)) : (h.append(g), C && h.append(C)), f++;
							}
			...
			return {
				_init: function p() {
					...
					E.opts.toolbarInline || E.opts.toolbarBottom || ((E.$second_tb = S(E.doc.createElement("div")).attr("class", "fr-second-toolbar")), E.$box.append(E.$second_tb), (!1 !== E.ul || E.opts.attribution) && E.$second_tb.prepend(V.POWERED_BY)),
						E.opts.toolbarContainer
							? (E.shared.$tb ? ((E.$tb = E.shared.$tb), E.opts.toolbarInline && s()) : ((E.shared.$tb = S(E.doc.createElement("DIV"))), E.shared.$tb.addClass("fr-toolbar"), (E.$tb = E.shared.$tb), S(E.opts.toolbarContainer).append(E.$tb), d(), E.$tb.data("instance", E)),
